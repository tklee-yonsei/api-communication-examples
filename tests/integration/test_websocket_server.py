"""WebSocket API 서버 통합 테스트.

실제 WebSocket 연결을 통해 WebSocket API 서버를 테스트합니다.

테스트 대상:
- 동기 작업: echo, calc, stats
- 비동기 작업: hash, fib
- 작업 조회: get_job
- 목록/상태: list_jobs, get_queue_status
"""
...
class TestSyncJobs:
    ...
    def test_echo_job(self, client: WebSocketJobClient) -> None:
        """Echo 작업을 테스트합니다.
    ...
    def test_echo_empty_payload(self, client: WebSocketJobClient) -> None:
        """빈 페이로드로 Echo 작업을 테스트합니다.
    ...
    def test_calc_add(self, client: WebSocketJobClient) -> None:
        """Calc 작업 덧셈 연산을 테스트합니다.
    ...
    def test_calc_subtract(self, client: WebSocketJobClient) -> None:
        """Calc 작업 뺄셈 연산을 테스트합니다.
    ...
    def test_calc_multiply(self, client: WebSocketJobClient) -> None:
        """Calc 작업 곱셈 연산을 테스트합니다.
    ...
    def test_calc_divide(self, client: WebSocketJobClient) -> None:
        """Calc 작업 나눗셈 연산을 테스트합니다.
    ...
    def test_calc_divide_by_zero(self, client: WebSocketJobClient) -> None:
        """Calc 작업 0으로 나누기 시 에러를 테스트합니다.
    ...
    def test_stats_basic(self, client: WebSocketJobClient) -> None:
        """Stats 작업 기본 통계 계산을 테스트합니다.
    ...
    def test_stats_empty_values(self, client: WebSocketJobClient) -> None:
        """빈 리스트로 Stats 작업 호출 시 에러를 테스트합니다.
...
class TestAsyncJobs:
    ...
    def test_hash_job_creation(self, client: WebSocketJobClient) -> None:
        """Hash 작업 생성을 테스트합니다.
    ...
    def test_fib_job_creation(self, client: WebSocketJobClient) -> None:
        """Fib 작업 생성을 테스트합니다.
    ...
    def test_get_job_not_found(self, client: WebSocketJobClient) -> None:
    ...
    def test_queue_status(self, client: WebSocketJobClient) -> None:
        """GetQueueStatus를 테스트합니다.
...
class TestWebSocketServerIntegration:
    """실제 WebSocket 서버 통합 테스트.

    실제 서버를 띄우고 WebSocket 요청을 보내 전체 통합을 테스트합니다.
    """
    ...
    def test_hash_job_lifecycle(self, client: WebSocketJobClient) -> None:
    ...
    def test_fib_job_lifecycle(self, client: WebSocketJobClient) -> None:
    ...
    def test_concurrent_requests(self, server: WebSocketServerThread) -> None:
        """동시 요청 처리를 테스트합니다.
    ...
    def test_multiple_async_jobs(self, client: WebSocketJobClient) -> None:
